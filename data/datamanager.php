...
abstract class DataManager
{
    ...
    protected static array $objectClass;

    /** @var Collection[] Cache of class names */
    protected static array $collectionClass;

    /** @var EntityObject[][] Objects that called delete() method themself */
    protected static array $currentDeletingObjects;
    ...
    public static function unsetEntity($class): void
    {
     ...
     * @return string
     */
    final public static function getObjectClassName(): string
    {
        $class = static::getObjectClass();
        return substr($class, strrpos($class, '\\') + 1);
    }

    protected static function getObjectClassByDataClass($dataClass): string
    {
