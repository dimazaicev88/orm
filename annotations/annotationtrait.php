...
trait AnnotationTrait
{
     ...
     */
    public static function annotateEntity(Entity $entity, bool $ufOnly = false, bool $separateTable = false): array|string|null
    {
    ...
    public static function annotateScalarField(ScalarField $field): array
    {
    ...
    public static function annotateUserType(UserTypeField $field): array
    {
        // no setter
        $objectClass = $field->getEntity()->getObjectClass();
    ...
    public static function annotateExpression(ExpressionField $field): array
    {
        // no setter
        $objectClass = $field->getEntity()->getObjectClass();
    ...
    public static function annotateReference(Reference $field): array
    {
    ...
    public static function annotateOneToMany(OneToMany $field): array
    {
        if (!static::tryToFindEntity($field->getRefEntityName())) {
            return [[], []];
        }
    ...
    public static function annotateManyToMany(ManyToMany $field): array
    {
        if (!static::tryToFindEntity($field->getRefEntityName())) {
            return [[], []];
        }
     ...
     */
    public static function tryToFindEntity($entityClass): bool
    {
    ...
    protected static function getFieldNameCamelCase($fieldName): array
    {
