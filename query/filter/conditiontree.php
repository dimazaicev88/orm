...
class ConditionTree
{
     ...
     *
     */
    public function whereNotIn($column, $values): static
    {
        $subFilter = new static();
     ...
     * @return $this
     */
    public function whereExists($query): static
    {
     ...
     *
     */
    public function whereNotExists($query): static
    {
     ...
     *
     */
    public function whereMatch($column, $value): static
    {
     ...
     *
     */
    public function whereNotMatch($column, $value): static
    {
        $subFilter = new static();
     ...
     *
     */
    public function whereExpr($expr, $arguments): static
    {
