...
class Query
{
    ...
    /** @var Filter */
    protected Filter $filterHandler;

    /** @var Filter */
    protected Filter $whereHandler;

    /** @var Filter */
    protected Filter $havingHandler;

    /**
     * @var Chain[]
     */
    protected array $group_chains = []; // all chain storages keying by alias
    protected array $order_chains = []; // all chain storages keying by alias
    protected array $select_chains = []; // all chain storages keying by alias

    /**
     * @var Chain[]
     */
    protected array $having_chains = [];
    protected array $where_chains = [];
    protected array $filter_chains = [];

    /**
     * @var Chain[]
     */
    protected array $hidden_chains = [];
    protected array $having_expr_chains = [];
    protected array $select_expr_chains = [];

    /**
     * Fields in result that are visible for fetchObject, but invisible for array
     * @var string[]
     */
    protected array $forcedObjectPrimaryFields;

    /** @var Chain[] */
    protected array $runtime_chains = [];

    /** @var Chain[] */
    protected $global_chains = []; // keying by both def and alias

    /** @var string[] */
    protected $query_build_parts;

    /** @var Expression */
    protected static Expression $expressionHelper;
     ...
     * @var bool
     */
    protected bool $data_doubling_off = false;
     ...
     * @var bool
     */
    protected bool $private_fields_on = false;

    /** @var string */
    protected string $table_alias_postfix = '';

    /** @var string Custom alias for the table of the init entity */
    protected ?string $custom_base_table_alias = null;

    /** @var array */
    protected array $join_map = [];

    /** @var array list of used joins */
    protected array $join_registry;

    /** @var Union */
    protected Union $unionHandler;
    ...
    protected array $replaced_aliases = [];

    /** @var array Replaced table aliases */
    protected array $replaced_taliases = [];

    /** @var int */
    protected int $uniqueAliasCounter = 0;

    /** @var callable[] */
    protected array $selectFetchModifiers = array();

    protected bool $cacheJoins = false;
    protected int $cacheTtl = 0;

    /**
     * @param string|Entity|Query $source
     *
     * @throws Main\ArgumentException
     * @throws Main\SystemException
     */
    public function __construct(Query|Entity|string $source)
    {
     ...
     * @return $this
     */
    public function addSelect(mixed $definition, string $alias = ''): static
    {
        if ($alias <> '') {
     ...
     * @return Filter
     */
    public function getFilterHandler(): Filter
    {
     ...
     * @throws Main\SystemException
     */
    public function addOrder(string $definition, string $order = 'ASC'): static
    {
     ...
     *
     */
    public function setUnionOrder($order): static
    {
     ...
     *
     */
    public function addUnionOrder(string $definition, string $order = 'ASC'): static
    {
     ...
     * @throws Main\SystemException
     */
    public function setUnionLimit($limit): static
    {
     ...
     * @throws Main\SystemException
     */
    public function setUnionOffset($offset): static
    {
     ...
     *
     */
    public function enableDataDoubling(): static
    {
     ...
     * @return $this
     */
    public function disableDataDoubling(): static
    {
     ...
     * @return $this
     */
    public function enablePrivateFields(): static
    {
     ...
     * @return $this
     */
    public function disablePrivateFields(): static
    {
     ...
     * @return bool
     */
    public function isPrivateFieldsEnabled(): bool
    {
     ...
     */
    protected function checkForPrivateFields(): void
    {
        // check in filter
     ...
     * @throws SystemException
     */
    public static function isFieldPrivate($field): bool
    {
     ...
     *
     * @param string|Field|null $name
     * @param array|Field|null $fieldInfo
     *
     * @return $this
     * @throws Main\ArgumentException
     * @throws Main\SystemException
     */
    public function registerRuntimeField(Field|string|null $name, Field|array $fieldInfo = null): static
    {
    ...
    public function setTableAliasPostfix($postfix): static
    {
        $this->table_alias_postfix = $postfix;
        return $this;
    }

    public function getTableAliasPostfix(): string
    {
     ...
     * @return $this
     */
    public function setCustomBaseTableAlias($alias): static
    {
     ...
     *
     */
    public static function expr(?string $alias = null): Expression
    {
